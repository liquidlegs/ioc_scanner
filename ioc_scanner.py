...
def main():
  ...
  file_parser.add_argument("-a", "--av", action="store_true", help="View the list of vendors that have flagged an ioc.")
  ...
  ip_parser.add_argument("--av", action="store_true", help="View the list of vendors that have flagged an ioc.")
  ...
  url_parser.add_argument("--av", action="store_true", help="View the list of vendors that have flagged an ioc.")
